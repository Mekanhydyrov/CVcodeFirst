<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Administatistik.aspx.cs" Inherits="CvEntityCore.Administatistik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <link href="istatistik/css/style.css" rel="stylesheet" />
    <link href="istatistik/css/jqvmap.css" rel="stylesheet" />
    <script src="istatistik/js/Chart1.js"></script>
    <script src="istatistik/js/jquery.min.js"></script>
    <script src="istatistik/js/jquery.vmap.js"></script>
    <script src="istatistik/js/jquery.vmap.sampledata.js"></script>
    <script src="istatistik/js/jquery.vmap.world.js"></script>
    ...
    <div class="total-world">
        ...
        <div class="site-report">
            ...
            <p>Cv projemizin admin paneli kısmındasınız. Keyfli Düzenlemeler.</p>
        </div>
        <div class="clearfix"></div>
    </div>
